...
Copyable example: [`docs/guides/auth.identities.example.json`](auth.identities.example.json).
...
For noisy targets that return the same infrastructure 500 repeatedly, use `-skip-endpoint-on-500` instead of, or in addition to, `-skip-on-crash`. See the security profiles in [`INSTRUCTIONS.md`](../getting-started/quickstart.md#security-campaign-profiles) and the full flag table in [`void/README.md`](../../src/void/cmd/void/README.md#fuzzer-flags-full-reference).
...
a new requirement on identity shape. See `src/void/internal/engine/jwt_expiry.go` and its test file
for the exact logic.
...
**→ [Back to README](../../README.md) · [Full Runbook](../getting-started/quickstart.md) · [Go Fuzzer Reference](../../src/void/cmd/void/README.md)**
