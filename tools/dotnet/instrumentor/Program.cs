...
try
{
    ...
    // of a fixed 256KB guess (see bin/fuzz-prep-multi.py::ResolveShmSize). SharpFuzz
...
// so bin/fuzz-prep-multi.py only ever passes --cmplog for hook-mode builds.
//
...
public static class CmpLogInstrumentor
{
    public static void Run(string dllPath, Func<string, bool> shouldInstrument)
    {
        ...
        // SharpFuzz.Common.Trace at runtime (see bin/fuzz-prep-multi.py's CoverageRuntime):
