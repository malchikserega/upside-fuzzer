...
"""
        ...
        # (confirmed empirically on demo_app/: TeamFlow.Infrastructure.dll -- which
        ...
        sync_commands = "\n".join(
            f"RUN cp /src/{p.path}/bin/Release/{p.target_framework}/{p.name}.dll "
            f"/src/{main_proj.path}/bin/Release/{main_proj.target_framework}/{p.name}.dll"
